...
describe("Enforcer (ACL)", () => {
  ...
  test.skip("enforcer.getAllRoles", async () => {
    await expect(enforcer.getAllRoles()).resolves.toEqual([]);
  });

  test.skip("enforcer.getAllNamedRoles", async () => {
  ...
  test.skip("enforcer.getGroupingPolicy", async () => {
    await expect(enforcer.getGroupingPolicy()).resolves.toEqual([]);
  });

  test.skip("enforcer.getNamedGroupingPolicy", async () => {
    await expect(enforcer.getNamedGroupingPolicy("p")).resolves.toEqual([]);
  });

  test.skip("enforcer.getFilteredNamedGroupingPolicy", async () => {
    await expect(
  ...
  test.skip("enforcer.hasGroupingPolicy", async () => {
    await expect(
      enforcer.hasGroupingPolicy("alice", "data2_admin"),
    ).resolves.toBe(true);
  });

  test.skip("enforcer.hasNamedGroupingPolicy", async () => {
    await expect(
      enforcer.hasNamedGroupingPolicy("g", "alice", "data2_admin"),
    ).resolves.toBe(true);
  });

  test.skip("enforcer.addGroupingPolicy", async () => {
    await expect(
      enforcer.addGroupingPolicy("group1", "data2_admin"),
    ).resolves.toBe(true);
  });

  test.skip("enforcer.addGroupingPolicies", async () => {
    await expect(
  ...
  test.skip("enforcer.addNamedGroupingPolicy", async () => {
    await expect(
      enforcer.addNamedGroupingPolicy("g", "group1", "data2_admin"),
    ).resolves.toBe(true);
  });

  test.skip("enforcer.removeGroupingPolicy", async () => {
    await expect(
      enforcer.removeGroupingPolicy("alice", "data2_admin"),
    ).resolves.toBe(true);
  });

  test.skip("enforcer.removeGroupingPolicies", async () => {
    await expect(
      enforcer.removeGroupingPolicies([
        ["jack", "data4", "read"],
        ["katy", "data4", "write"],
        ["leyo", "data4", "read"],
        ["ham", "data4", "write"],
  ...
  test.skip("enforcer.removeFilteredGroupingPolicy", async () => {
    await expect(
  ...
  test.skip("enforcer.removeNamedGroupingPolicy", async () => {
    await expect(
      enforcer.removeNamedGroupingPolicy("g", "alice"),
    ).resolves.toBe(false);
  });

  test.skip("enforcer.removeNamedGroupingPolicies", async () => {
    await expect(
  ...
  test.skip("enforcer.removeFilteredNamedGroupingPolicy", async () => {
    await expect(
      enforcer.removeFilteredNamedGroupingPolicy("g", 0, "alice"),
    ).resolves.toBe(false);
  });
});
